...
def resume_categorizer():
        ...
        # Resume Folder Path
        path = r"D:\\IR PROJECT\\Rafay_Project\\Rafay_Project\\Project Code\\Resume"
        ...
        for file in os.listdir():
            ...
            if file.endswith(".txt"):
                ...
                f_name = str(file)
                f_name = f_name.replace("D:\\IR PROJECT\\Rafay_Project\\Rafay_Project\\Project Code\\Resume","")
        ...
        path = r"D:\IR PROJECT\Rafay_Project\Rafay_Project\Project Code"
        os.chdir(path)
